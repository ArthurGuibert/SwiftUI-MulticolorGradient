...
extension MirrorAnimation {
    ...
    private static func animationDurationAndDelay(from mirror: Mirror) -> (duration: Double?, delay: Double?) {
        var delay: Double?
        var duration: Double?
        for c in mirror.children {
            switch c.label {
    ...
    private static func animationDurationAndRepeat(from mirror: Mirror) -> (duration: Double?, repeatCount: Int?, autoreverses: Bool?) {
        var repeatCount: Int?
